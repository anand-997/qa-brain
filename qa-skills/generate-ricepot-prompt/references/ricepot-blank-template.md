<!-- Context: This is the blank 7-section RICE-POT skeleton used by the
`/generate-ricepot-prompt` skill (qa-skills/generate-ricepot-prompt/) as the structure to
fill in for any new task. It is a copy of the shared qa-skills/RICE-POT-TEMPLATE.md, kept
here so the skill folder is self-contained and portable on its own. -->
