---
name: ra-lookup
description: Quick REST Assured syntax reference and code snippets. Use when the user needs RestAssured HTTP method patterns, authentication setup, query/path parameters, Hamcrest matchers, Jackson annotations, TestNG lifecycle annotations, or content type constants.
---
