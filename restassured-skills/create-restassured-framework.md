...
description: Bootstrap a complete REST Assured + TestNG + Maven API test automation framework from scratch. Use when the user wants to create a new framework, start a new API automation project, or set up the full project structure with all core classes.
---
