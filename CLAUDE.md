...
```
qa-brain/
├── selenium-skills/      # 4 skills — Selenium WebDriver 4.x + TestNG + Maven
├── restassured-skills/   # 4 skills — REST Assured 5.4.0 + TestNG + Maven
├── qa-skills/            # 2 skills — test case generation and requirements research
